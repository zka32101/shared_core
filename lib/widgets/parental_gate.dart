...
/// ```
///
/// 文言をアプリ側でカスタマイズしたい場合は `title` / `description` /
/// `okLabel` / `cancelLabel` を上書きする。多くの場合は
/// `requireParentalGate()`（`utils/parental_gate_helper.dart`）を使う方が簡潔。
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(fontSize: 14, height: 1.6, color: kTextMuted),
              textAlign: TextAlign.center,
            ),
            const SizedBox(height: 16),
            Text(
